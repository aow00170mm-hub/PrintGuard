...
try{Invoke-RestMethod 'http://127.0.0.1:8080/api/dashboard' -TimeoutSec 3|Out-Null;Write-Host 'API: healthy' -ForegroundColor Green}catch{Write-Host "API: unavailable ($($_.Exception.Message))" -ForegroundColor Red}
